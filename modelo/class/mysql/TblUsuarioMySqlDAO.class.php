...
class TblUsuarioMySqlDAO implements TblUsuarioDAO{
	...
	public function insert($tblUsuario){
		$sql = 'INSERT INTO tbl_usuario (id_empleado, contrasena, privilegio, usuario) VALUES (?, ?, ?, ?)';
		$qpos = 0;
	...
	public function update($tblUsuario){
		$sql = 'UPDATE tbl_usuario SET id_empleado = ?, contrasena = ?, privilegio = ?, usuario = ? WHERE id_usuario = ?';
		$qpos = 0;
